...
export default function News() {
    return (
        <>
            ...
            <section className="grid grid-cols-1  xl:grid xl:grid-cols-4 xl:mx-auto xl:max-w-[90rem] xl:mt-12 px-6">
            ...
            <section className="grid grid-cols-1 xl:grid-cols-4 w-full  mt-[51px]  xl:mx-auto xl:max-w-[90rem] px-6">
