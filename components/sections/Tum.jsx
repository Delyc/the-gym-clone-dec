    ...
    return(
        ...
        <section className="xl:mx-auto xl:max-w-[90rem] mt-[96px] px-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-5 gap-[24px] mt-[48px]">
                <div className="xl:col-span-3 py-2 xl:py-0 w-[17rem] w-auto xl:w-auto xl:row-span-2 bg-primary-blue xl:px-[40px] flex flex-col items-center xl:items-start">
                ...
                <div className="bg-primary-yellow xl:col-span-2 xl:flex xl:flex-row flex flex-col w-[17rem] w-auto xl:w-auto items-center  justify-between px-[20px]  items-center">
                ...
                <div className="bg-secondary-purple py-2 xl:py-0 w-[17rem] w-auto xl:w-auto items-center flex flex-col xl:flex xl:flex-row xl:col-span-2  xl:justify-between xl:px-[20px]  items-center">
