export default function HomePage(){
    return(
        ...
        <div className="absolute top-16 py-16 px-15 flex flex-col gap-6 mx-auto max-w-[90rem]">
...
<div className="w-11 h-11 bg-primary-blue absolute grid place-content-center  bottom-[-20rem] right-[-45rem]">
