...
export default function Program(){
    ...
    return(
        ...
        <Link href="#" className='w-full flex gap-2 justify-end text-primary-blue font-bold mt-[20px]'>Degree programs<Image src={next} alt="next" height={20} width={20} className="hidden md:block"/></Link>
