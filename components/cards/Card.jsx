...
export default function Card({image, tag, smallHeading, bigHeading, description, datePosted, readingTime, styles, buttonText}){
    let value=0
    return(
        <div className={`${styles} group w-full xl:w-[332px] mt-10 xl:mt-0 flex flex-col gap-3`}>
            <div className='group-hover:bg-red-500 relative w-full'>
            <Image src={image} alt="news" width={332} height={160} className="xl:w-full h-[256px] object-cover w-full" />
